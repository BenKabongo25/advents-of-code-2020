...
def test():
    datas = """ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
pid:3556412378 byr:2007""".split('\n')
    print(func2(datas)==0)
    datas = """pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
