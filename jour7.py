...
datas = '''faded plum bags contain 5 wavy cyan bags.
...
faded tan bags contain 4 posh magenta bags, 1 pale teal bag.'''.split('\n')
...
def test():
    datas = '''light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags.'''.split('\n')
    print(func1(datas))
    print(func2(datas))
    datas = '''shiny gold bags contain 2 dark red bags.
